...
{
    //self.setMusicPicker:@"Country";
    //self.setChoiceLabel:@"Pick Music From a Decade";
    //self.NSInteger genrerow=[musicPicker selectedRowInComponent:0];
    //self.NSInteger decaderow=[musicPicker selectedRowInComponent:1];
