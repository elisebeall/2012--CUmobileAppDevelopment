...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // set MADHomeViewController to be the initial start up view controller
    MADHomeViewController *homeViewController = [[MADHomeViewController alloc] initWithNibName:@"MADHomeViewController" bundle:nil];
